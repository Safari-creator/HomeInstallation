        ...
        <div className="dashboard-section">
            ...
            <section className="dashboard-header">
                ...
                <div className="header-right">
                    ...
                    <img className="header-icon-one" src={headerIconOne} style={{ cursor: 'pointer' }} alt="headerIconOne" title='Notifications'></img>
                    ...
                    <span className='fa fa-sign-out' style={{ fontSize: 25, cursor: 'pointer' }} title='Logout' onClick={() => {
