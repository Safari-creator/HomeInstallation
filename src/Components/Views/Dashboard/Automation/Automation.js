            ...
            <section className="body-part">
                <div class="flex space-between">
                    <div class="part-one-left flex space-between">
                        <span className='buttons'>Email Queue</span>
                    </div>
                    <div class="part-one-left flex space-between">
                        <span className='buttons'>Email Sent</span>
                    </div>
                    <div class="part-one-left flex space-between">
                        <span className='buttons'>Text Queue</span>
                    </div>
                    <div class="part-one-left flex space-between">
                        <span className='buttons'>Text Sent</span>
                    </div>
                </div>
                <div class="body-part-two bot50 pt-4">
